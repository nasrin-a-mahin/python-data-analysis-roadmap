...
- Boolean indexing & reshaping
- Mini Project: **Sales Data Analysis using NumPy**

### 🔵 Week 3: Pandas (Core Data Analysis)
- DataFrames & Series
- Data cleaning
- GroupBy, merge & join
- Mini Project: **Employee Salary Analysis**

### 🟣 Week 4: Visualization, Stats & Projects
- Matplotlib & Seaborn
...
## 📂 Datasets
All sample datasets used in this project are stored in the `datasets/` folder.

The datasets used in this repository are sourced from Kaggle and are used strictly for educational and practice purposes.
...
│   ├── Day-02-Conditions.ipynb
│   ├── Day-03-Loops.ipynb
│   ├── Day-04-Lists-Tuples.ipynb
│   ├── Day-05-Sets-Dictionaries.ipynb
│   ├── Day-06-Functions.ipynb
│   └── Mini-Project-Student-Result-Analyzer.ipynb
│
├── Week-02-NumPy-Data-Handling/
│   ├── Day-08-File-Handling.ipynb
...
│   ├── Day-16-Data-Selection.ipynb
│   ├── Day-17-Data-Cleaning.ipynb
│   ├── Day-18-GroupBy-Aggregation.ipynb
│   ├── Day-19-Merge-Join.ipynb
│   └── Mini-Project-Employee-Salary-Analysis.ipynb
│
├── Week-04-Visualization-Stats-Projects/
│   ├── Day-22-Matplotlib.ipynb
│   ├── Day-23-Seaborn.ipynb
│   ├── Day-24-Statistics-Basics.ipynb
│   ├── Day-25-SQL-with-Python.ipynb
...
This repository focuses on building a strong foundation in Python data analysis.
Some advanced topics are planned for future expansion.

| Skill Area                                 | Coverage Status            | Notes |
|------------------------------------------|----------------------------|------|
